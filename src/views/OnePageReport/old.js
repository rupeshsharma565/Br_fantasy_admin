...
let frmthis=this;
    ...
    if (nextProps.onepagereport.onepagedata) {
      ...
      this.setState({ 
        ...
        console.log("show header",frmthis.state.heading,frmthis.state.headingShow.totaljoin);
      });
    }else{
       this.setState({ 
        onepagedata: null,
  ...
  handleSelectedPaginate(selectedPage) {
    let data={
       ...
       matchid:this.state.selectematch && this.state.selectematch > 0?this.state.selectematch:'',//this.state.selectematch,
  ...
  onClickPlayerList=(teamid,userid)=>{
    //console.log("::::::>>>>",this.state.selectedvcaptain, this.state.teamuserid, this.state.selectematch, teamid)
  ...
  onChangeCaptian(e){
    console.log("ec--->>>",e.target.value,this.state.selectedvcaptain);
  ...
  onChangeVCaptian(e){
    console.log("evc--->>>",e.target.value,this.state.selectedcaptain);
...
let replacePlayerList={};
  ...
  let data={
    ...
    console.log("data------->>>>",this.state.selectedcaptain,this.state.selectedvcaptain,data);
