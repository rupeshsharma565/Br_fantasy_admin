...
class CricketMatch extends Component {
  ...
  componentDidMount() {
    ...
    if(this.props.location.pathname==="/kabaddi/activematch"){
      gameid=3;
    }else if(this.props.location.pathname==="/cricket/activematch"){
      gameid=1;
    }else if(this.props.location.pathname==="/football/activematch"){
      gameid=2;
    }
  ...
  getValuePlayerType(playertypedetail) {
    ...
    if(playertypedetail)
    {
        if (playertypedetail.keeper) {
          return playertype = 1;
        } else if (playertypedetail.batsman && playertypedetail.bowler) {
          return playertype = 3;
        }
        else if (playertypedetail.batsman) {
          return playertype = 2;
        }
        else {
          return playertype = 4;
  ...
  converPlayerType(platertype){
    ...
    if(platertype)
    {
      if(platertype===1){
          ...
          return playertypedetail;
      }
      else if(platertype===2){
  ...
  toggleAccordionNew(matchDetails) {
    ...
    else
    {
        ...
        let matchurl="";
          matchurl=CONST.BACKEND_URL + "/ucmatch/1/" + matchid;
        ...
        formthis.setState({loading:false});
          if (response.data) {
                ...
                let mtype=response.data.match.format;
                formthis.getplayerdetails(matchid, teamC, 1,seriesid,mtype);
                formthis.setState({
  ...
  getplayerdetails(matchid, players, gameid,seriesid,mtype) {
    ...
    formData.append('matchtype', mtype);
    const config = {
      headers: {
        Authorization: authHeader().Authorization
      }
  ...
  onInputBoxChange2 = e => {
    // var index = this.state.playerList2.findIndex(x => x === e.target.id);
  ...
  onInputBoxChange1Update = e => {
    ...
    this.setState({
      ...
      //console.log("updatePlayerList1==========>>>>",formthis.state.updatePlayerList1)
    });
  ...
  setPlayerType1(e) {
    ...
    allPlayerList[e.target.id].identified_roles=this.converPlayerType(currentstatus);//this.state.allPlayerList.data[e.target.id].identified_roles;
    ...
    // let findindex = playerList1.players.findIndex(x => x === id);
    //  console.log("findindex  ", allPlayerList,findindex);
    // return;
  ...
  setPlayerType2(e) {
    ...
    //   playerList2
    // } = this.state;
    // console.log("findindex  ", playerList2);
  ...
  submitNewAddMatch(matchdetails) {
    ...
    if (this.state.playerList1 && this.state.playerList2) {
      ...
      this.state.playerList1.match.players.forEach((result1, index1) => {
        ...
        objPlayerList["ptype"] = this.getValuePlayerType(this.state.allPlayerList[result1].identified_roles);
        objPlayerList["fullname"] = this.state.allPlayerList[result1].fullname;
        objPlayerList["pname"] = this.state.allPlayerList[result1].name;
      ...
      this.state.playerList2.match.players.forEach((result2, index1) => {
        ...
        objPlayerList["ptype"] = this.getValuePlayerType(this.state.allPlayerList[result2].identified_roles);
        objPlayerList["fullname"] = this.state.allPlayerList[result2].fullname;
        objPlayerList["pname"] = this.state.allPlayerList[result2].name;
    ...
    if (this.state.selectedMatchDetails) {
      ...
      axios.post(CONST.BACKEND_URL + `/api/addmatch`, data, config).then(response => {
        ...
        if (response.data.code === 0) {
          this.getActiveMatchList();
          formthis.toggleAccordionNew(matchdetails);
  ...
  submitUpdatedMatch() {
    ...
    if (this.state.selectedMatchDetails) {
      this.setState({loading:true});
      //console.log("selectedMatchDetails   ",this.state.selectedMatchDetails);
  ...
  onChangePlaying1(e, chk) {
    console.log("--->>>", this.state.updatePlayerList1.findIndex(x => x.pid == e.target.id), e.target.checked);
  ...
  onChangePlaying2(e, chk) {
    console.log("--->>>", this.state.updatePlayerList2.findIndex(x => x.pid == e.target.id), e.target.checked);
                                    ...
                                    <ListGroup className="forscroll ">
                                      ...
                                      {(this.state.playerList1 && this.state.playerList1.match) ? (this.state.playerList1.match.players).map((player, index) => (
                                        <ListGroupItem key={index} >
                                          <Row>
                                            <Col xs="2">
                                              <img src={(formthis.state.allPlayerList[player] && formthis.state.allPlayerList[player].imgdetail) ? formthis.state.allPlayerList[player].imgdetail.pimg : ""} width="50" height="50" onError={(e) => { e.target.src = CONST.BACKEND_URL + '/uploads/players/dummy.png' }} className="img-avatar" style={{ cursor: 'pointer' }} alt="" onClick={() => this.showImageToggle1(player)} />
                                            </Col>
                                            <Col xs="4">{formthis.state.allPlayerList[player].fullname}</Col>
                                            <Col xs="6">
                                              <Row>
                                                <Col xs="6">
                                                ...
                                                <Col xs="8" className={"mt-top"}>
                                                  ...
                                                  <Input type="select" name="ptype" id={player} onChange={this.setPlayerType1} value={formthis.getValuePlayerType(formthis.state.allPlayerList[player].identified_roles)}>
                                          ...
                                          <Row>
                                            ...
                                            <Col xs="6">
                                              <Row>
                                                ...
                                                <Col xs="8" className={"mt-top"}>
                                                  <Input type="select" name="ptype" id={player} onChange={this.setPlayerType2} value={formthis.getValuePlayerType(formthis.state.allPlayerList[player].identified_roles)}>
