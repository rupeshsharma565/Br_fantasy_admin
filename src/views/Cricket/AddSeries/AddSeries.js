          ...
          <Col xl={6}>
            <Card>
              <CardHeader>
                <FormGroup row>
                  <Col xl="6">
                    <i className="fa fa-align-justify"></i> SERIES Listing <small className="text-muted"></small>
                  </Col>
                  <Col xl="2">
                  </Col>
                </FormGroup>
                  ...
                  <tbody>
                    {
                      items ? items.map((subadmin, index) =>
                        <tr key={subadmin.id}>
                          <td>{index}</td>
                          <td><img src={subadmin.contestlogo} alt="" onError={(e)=>{e.target.src=CONST.BACKEND_URL + '/uploads/icons/dummy.png'}} width="50" height="50" />&nbsp;&nbsp;&nbsp;&nbsp;{subadmin.title}</td>
                          <td>
