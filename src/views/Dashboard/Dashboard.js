...
class Dashboard extends Component {
  ...
  componentWillReceiveProps(next_state) {
    if (
      ...
      next_state.dashboard.dashboarddata &&
      next_state.dashboard.dashboarddata.barChartData &&
      next_state.dashboard.dashboarddata.barChartData.data &&
      next_state.dashboard.dashboarddata.barChartData.data.length > 0
    ) {
      this.setState({
        barChart: {
    ...
    return (
      <div className="animated fadeIn">
        <Row className="social-main">
          <Col xs="1">
            {" "}
            <div title="Web Users" className="social-icons">
              {" "}
              <i className="fa fa-user fa-lg "></i>{" "}
              <span className="social-count">
                {" "}
                {dashboarddata ? dashboarddata.social.web : 0}{" "}
              </span>{" "}
            </div>
          </Col>
          <Col xs="1">
            {" "}
            <div title="Android" className="social-icons">
              {" "}
              <i className="fa fa-android fa-lg "></i>{" "}
              <span className="social-count">
                {" "}
                {dashboarddata ? dashboarddata.social.android : 0}{" "}
              </span>{" "}
            </div>{" "}
          </Col>
          <Col xs="1">
            {" "}
            <div title="Iphone" className="social-icons">
              {" "}
              <i className="fa fa-apple fa-lg "></i>
              <span className="social-count">
                {" "}
                {dashboarddata ? dashboarddata.social.ios : 0}{" "}
              </span>{" "}
            </div>{" "}
          </Col>
        ...
        <Row>
          {this.state.permissions &&
            this.state.permissions.includes("/users/allusers") ? (
              <Col xs="6" sm="2" lg="2">
                <a className="dash-count" href={`/#/users/allusers`}>
                  <Card className="text-white bg-info">
                    <CardBody className="pb-0">
                      <div className="text-value">
                        {dashboarddata ? dashboarddata.totalusr : 0}
                      </div>
                      <div>Total user</div>
                    </CardBody>
          ...
          {this.state.permissions &&
            this.state.permissions.includes("/subadmin") ? (
              <Col xs="6" sm="2" lg="2">
                <a className="dash-count" href={`/#/subadmin`}>
                  <Card className="text-white bg-primary">
                    <CardBody className="pb-0">
                      <div className="text-value">
                        {dashboarddata ? dashboarddata.totalsbadmin : 0}
                      </div>
          ...
          {this.state.permissions &&
            this.state.permissions.includes("/withdraw") ? (
              <Col xs="6" sm="2" lg="2">
                <a className="dash-count" href={`/#/withdraw`}>
                  ...
                  >
                    <CardBody className="pb-0">
                      <div className="text-value">
                        {dashboarddata ? dashboarddata.withdrawals : 0}
                      </div>
                      <div>Withdrawals</div>
                    </CardBody>
                    <div
          ...
          {this.state.permissions &&
            this.state.permissions.includes("/kyc/approved") ? (
              <Col xs="6" sm="2" lg="2">
                <a className="dash-count" href={`/#/kyc/approved`}>
                  <Card className="text-white bg-green">
                    <CardBody className="pb-0">
                      <div className="text-value">
                        {dashboarddata ? dashboarddata.approve : 0}
                      </div>
          ...
          {this.state.permissions &&
            this.state.permissions.includes("/kyc/notapproved") ? (
              <Col xs="6" sm="2" lg="2">
                <a className="dash-count" href={`/#/kyc/notapproved`}>
                  <Card className="text-white bg-red">
                    <CardBody className="pb-0">
                      <div className="text-value">
                        {dashboarddata ? dashboarddata.notApproved : 0}
                      </div>
          ...
          {this.state.permissions &&
            this.state.permissions.includes("/communication/notifications") ? (
              <Col xs="6" sm="2" lg="2">
                <a className="dash-count" href={`/#/communication/notifications`}>
                  ...
                  >
                    <CardBody className="pb-0">
                      <div className="text-value">
                        {dashboarddata ? dashboarddata.notification : 0}
                      </div>
