...
class HowPlay extends Component {
  ...
  componentDidMount() {
    this.props.dispatch(settingActions.getstaticpage({slug:'howtoplay'}));
  }
      ...
      <div className="animated fadeIn">
       {staticpageDetails  ? <Row>
          <Col xl="12">
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify" /> How To Play
...
export default connect(mapStateToProps)(HowPlay);
